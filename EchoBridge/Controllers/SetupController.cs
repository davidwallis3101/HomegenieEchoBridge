    ...
    public class SetupController : ApiController
    {
        ...
        public HttpResponseMessage Get()
        {
            ...
            string hueTemplate = "<?xml version=\"1.0\"?>\n" +
              ...
              "<friendlyName>Homegenie Hue Bridge</friendlyName>\n" +
              "<manufacturer>Royal Philips Electronics</manufacturer>\n" +
              "<manufacturerURL>http://www.nanoweb.com</manufacturerURL>\n" +
              "<modelDescription>Hue to HG Bridge for Amazon Echo</modelDescription>\n" +
              "<modelName>Philips hue bridge 2012</modelName>\n" +
              "<modelNumber>929000226503</modelNumber>\n" +
              "<modelURL>https://github.com/davidwallis3101/HomegenieEchoBridge</modelURL>\n" +
